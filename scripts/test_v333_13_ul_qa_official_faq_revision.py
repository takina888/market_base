#!/usr/bin/env python3
"""Regression checks for V333.13 UL/CE Q&A official-FAQ revision."""
...
BUILD_ID = "MARKET_BASE_V333_13_UL_QA_OFFICIAL_FAQ_REVISION_20260804"
TOKEN = "20260804-v333-13-ul-qa-official-faq-revision"
OFFLINE_ID = "MARKET_BASE_OFFLINE_MANIFEST_V333_13_UL_QA_OFFICIAL_FAQ_REVISION_20260804"
...
def main() -> None:
    ...
    check(manifest["version"] == "V333.13", "manifest version mismatch")
    ...
    for path in active_files:
        ...
        check("MARKET_BASE_V333_12_UL_QA_EXPLANATION_DEPTH_20260803" not in text, f"old build ID in {path}")
        check("20260803-v333-12-ul-qa-explanation-depth" not in text, f"old token in {path}")
