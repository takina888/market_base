#!/usr/bin/env python3
"""Cumulative feature regression checks retained by V333.14."""
...
BUILD = "MARKET_BASE_V333_14_CACHE_REFRESH_STABILIZATION_20260804"
...
def main() -> None:
    # WORK CODE controls introduced before V333.14 must remain intact.
    ...
    require(manifest.get("version") == "V333.14", "manifest version mismatch")
