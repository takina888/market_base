...
SCHOOL_METRICS={'school_meals_total_schools':('給食提供学校数','schools'),'school_meals_total_children':('給食対象児童・生徒数','children'),'school_meal_children_per_primary_enrollment_pct':('給食提供率（参考）','%')}
