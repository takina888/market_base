...
const output = path.join(root, 'assets/js/market-base-offline-manifest-v334.js');
...
for (const file of files) {
  ...
  if (textExtensions.has(extension)) {
    if (relative !== 'assets/js/market-base-offline-manifest-v334.js') {
...
textAssets.push('./assets/js/market-base-offline-manifest-v334.js');
textAssets.sort();
supportAssets.sort();
