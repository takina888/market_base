#!/usr/bin/env python3
"""Build cumulative V333.12 full and V333.8-overwrite packages."""
...
BASELINE_ZIP = WORKSPACE / "library_restore" / "MARKET_BASE_V333_8_FULL_HANDOFF_AND_DATA_20260803.zip"
FULL_ZIP = OUTPUT / "MARKET_BASE_V333_12_FULL_HANDOFF_AND_DATA_20260803.zip"
OVERWRITE_ZIP = OUTPUT / "MARKET_BASE_V333_12_OVERWRITE_FROM_V333_8_20260803.zip"
REPORT = ROOT / "HANDOFF_DOCUMENTS" / "V333_12_CHANGED_FILES_FROM_V333_8_20260803.txt"
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="market-base-v33312-") as temporary:
        ...
        REPORT.write_text(
            "\n".join(
                [
                    "MARKET BASE V333.12 cumulative changed files from public V333.8",
