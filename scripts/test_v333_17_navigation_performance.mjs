...
const TOKEN='20260810-v333-17-cache-coherence-smooth-navigation';
const html=read('index.html');
const app=read('assets/js/app-v273-country-profile-r28-refresh-route-header-r98.js');
const deferred=read('assets/js/market-base-home-deferred-v333-17.js');
const navigation=read('assets/js/market-base-navigation-v333-17.js');
const shell=read('assets/js/market-base-pc-unified-shell-v333-17.js');
...
const css=read('assets/css/market-base-navigation-v333-17.css');
...
assert(scriptSources.some(source=>source.includes(`app-v273-country-profile-r28-refresh-route-header-r98.js?v=${TOKEN}`)),'index must load app R98 with the V333.17 token');
...
console.log(`V333.17 navigation/performance contracts passed (${initialBytes} initial raw JS bytes).`);
