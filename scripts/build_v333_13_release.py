#!/usr/bin/env python3
"""Build cumulative V333.13 full and V333.8-overwrite packages."""
...
FULL_ZIP = OUTPUT / "MARKET_BASE_V333_13_FULL_HANDOFF_AND_DATA_20260804.zip"
OVERWRITE_ZIP = OUTPUT / "MARKET_BASE_V333_13_OVERWRITE_FROM_V333_8_20260804.zip"
REPORT = ROOT / "HANDOFF_DOCUMENTS" / "V333_13_CHANGED_FILES_FROM_V333_8_20260804.txt"
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="market-base-v33313-") as temporary:
        ...
        REPORT.write_text(
            "\n".join(
                [
                    "MARKET BASE V333.13 cumulative changed files from public V333.8",
