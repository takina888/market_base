...
--------------------
  SML_TOTAL_SCHOOLS   -> school_meals_total_schools
...
INDICATORS = {
    'SML_TOTAL_SCHOOLS': {
        'key':'school_meals_total_schools', 'unit':'schools', 'label_ja':'給食提供学校数',
        'label_en':'Schools providing school meals (total)'
    },
    'SML_TOTAL_CHILDREN': {
        'key':'school_meals_total_children', 'unit':'children', 'label_ja':'給食対象児童・生徒数',
...
SCHOOL_METRICS['school_meal_children_per_primary_enrollment_pct'] = {'label':'給食提供率（参考）','unit':'%'}
