#!/usr/bin/env python3
"""Cumulative content/data regression checks for MARKET BASE V333.15."""
...
OFFLINE_ID = "MARKET_BASE_OFFLINE_MANIFEST_V333_15_COUNTRY_DISTINCTIVE_FACTS_20260809"
...
def main() -> None:
    ...
    check(manifest["version"] == "V333.15", "manifest version mismatch")
    ...
    active_files = [
        ...
        ROOT / "assets" / "js" / "market-base-update-controller-v335.js",
        ROOT / "index.html",
        ROOT / "offline.html",
    ...
    check("controllerRevision: 'v335'" in controller, "V333.15 controller revision missing")
    ...
    check("market-base-update-controller-v335.js" in service_worker, "V333.15 controller missing from worker shell")
