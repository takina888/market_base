...
assert.equal(manifest.buildId, 'MARKET_BASE_V333_17_CACHE_COHERENCE_SMOOTH_NAVIGATION_20260810');
assert.equal(manifest.assetVersion, '20260810-v333-17-cache-coherence-smooth-navigation');
...
assert(offlineSettings.includes('MARKET_BASE_V333_17_CACHE_COHERENCE_SMOOTH_NAVIGATION_20260810'));
