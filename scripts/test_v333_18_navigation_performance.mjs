...
assert(scriptSources.some(source=>source.includes(`app-v273-country-profile-r28-refresh-route-header-r99.js?v=${TOKEN}`)),'index must load app R99 with the V333.18 token');
...
console.log(`V333.18 navigation/performance contracts passed (${initialBytes} initial raw JS bytes).`);
