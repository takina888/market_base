#!/usr/bin/env python3
"""Build and verify MARKET BASE V333.19 delivery archives.

The overwrite archive is calculated from the exact public V333.10 full ZIP,
then applied to that baseline and byte-compared with the full V333.19 tree.
"""
...
FULL_ZIP = WORKSPACE / f"MARKET_BASE_V333_19_FULL_HANDOFF_AND_DATA_{DATE}.zip"
OVERWRITE_ZIP = WORKSPACE / f"MARKET_BASE_V333_19_OVERWRITE_FROM_V333_10_{DATE}.zip"
CHECKSUMS = WORKSPACE / f"MARKET_BASE_V333_19_SHA256SUMS_{DATE}.txt"
REPORT = ROOT / "HANDOFF_DOCUMENTS/V333_19_CHANGED_FILES_FROM_V333_10_20260810.txt"
...
def main() -> None:
    ...
    with tempfile.TemporaryDirectory(prefix="market-base-v33319-") as temporary:
        ...
        REPORT.write_text(
            "\n".join(
                [
                    "MARKET BASE V333.19 cumulative changed files from public V333.10",
