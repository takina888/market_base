(function(){
  ...
  var chatgpt=document.querySelector('[data-home-search-action="chatgpt"]');
  ...
  if(chatgpt)chatgpt.addEventListener('click',function(){var opened=window.open('https://chatgpt.com/','_blank','noopener,noreferrer');if(opened)opened.opener=null;});
