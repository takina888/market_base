      ...
      <section class="mb-radio-dock-panel" id="mbRadioDockPanel" aria-label="世界のラジオ操作">
        ...
        <div class="mb-radio-dock-actions">
          ...
          <a class="mb-radio-dock-open" id="mbRadioDockOpen"
            href="${new URL('world-radio/player.html?id=wnyc&autoplay=1&v=20260803-v332-global-refresh-shell-dock-workphoto-line-no-chatgpt', siteRoot).href}"
  ...
  function render(state = readState()) {
    ...
    if (!currentState) {
      ...
      openLink.href = new URL(
        'world-radio/player.html?id=wnyc&autoplay=1&v=20260803-v332-global-refresh-shell-dock-workphoto-line-no-chatgpt',
        siteRoot
      ).href;
      message.textContent = '';
    ...
    openLink.href = new URL(
      `world-radio/player.html?id=${encodeURIComponent(currentState.stationId)}&autoplay=1&v=20260803-v332-global-refresh-shell-dock-workphoto-line-no-chatgpt`,
      siteRoot
    ).href;
