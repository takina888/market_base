    ...
    tools: [
      {
        ...
        label: '計算機・単位換算',
        icon: 'calculator',
        href: 'market-base-currency-converter-v273-r29.html?tool=calculator&v=20260802-v331-dock-list-update-hotfix'
      },
      {
        id: 'currency',
        order: 20,
        label: '為替換算',
        icon: 'currency',
        href: 'market-base-currency-converter-v273-r29.html?tool=currency&v=20260802-v331-dock-list-update-hotfix'
      },
      {
        id: 'code',
        order: 900,
        label: 'WORK CODE',
        icon: 'code',
        href: 'market-base-code-tool.html?v=20260802-v331-dock-list-update-hotfix'
      }
    ]
  });
