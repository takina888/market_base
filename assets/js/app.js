...
function renderCompare(){
  ...
  document.getElementById('compareTable').innerHTML=`<div class="compare-ui-shell">
    <section class="compare-hero-card">
      <div class="compare-hero-text"><span class="compare-kicker">COUNTRY COMPARE</span><h3>国と国を、同じ画面で比べる</h3><p>基本統計、米、学校給食、日本関連をカードで整理します。未収録は未収録として表示し、推測値は作りません。</p></div>
      <div class="compare-country-pair">${compareEntityHero(a,'比較A')}<div class="compare-vs-pill">VS</div>${compareEntityHero(b,'比較B')}</div>
    </section>
    <div class="compare-category-strip"><span>🌐 基本</span><span>🍚 米</span><span>🏫 学校給食</span><span>🇯🇵 日本関連</span></div>
...
const MARKET_BASE_APP_VERSION = 'V256_SPECIALIST_REFRESH_BUTTONS_20260713';
