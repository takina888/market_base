...
function flagMarkup(e, cls='flag-img'){
  ...
  return `<span class="flag-asset ${safe(cls)}"><img src="assets/flags/svg/${id}.svg" alt="${name} flag" loading="lazy" onerror="this.style.display='none'; this.nextElementSibling.style.display='inline-flex';"><span class="flag-emoji-fallback">${emoji}</span></span>`;
}
