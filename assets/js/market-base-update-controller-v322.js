(function (global) {
  ...
  const radioDockUrl = new URL(
    'assets/js/market-base-radio-dock-v330.js?v=20260803-v333-7-2-work-code-controls',
    siteRoot
  );
  const secondaryDockUrl = new URL(
    'assets/js/market-base-tool-dock-v330.js?v=20260803-v333-7-2-work-code-controls',
    siteRoot
  );
