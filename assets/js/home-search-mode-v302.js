(function(){
  ...
  function setMode(next,focus){
    ...
    tabs.forEach(function(tab){
      var active=tab.dataset.homeSearchMode===mode;
  ...
  tabs.forEach(function(tab){
    ...
    tab.addEventListener('keydown',function(event){
      ...
      setMode(mode==='internal'?'google':'internal',true);
    });
  });
  // Capture phase: only Google mode intercepts. Internal mode continues to the existing MARKET BASE handler.
  form.addEventListener('submit',function(event){
    ...
    var opened=window.open('https://www.google.com/search?q='+encodeURIComponent(query),'_blank','noopener,noreferrer');
