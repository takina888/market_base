(function(){
  ...
  var UPDATE_CONTROLLER_URL=new URL('assets/js/market-base-update-controller-v322.js?v=20260730-v324-radio-edge',SITE_ROOT);
  var LEARN_PREFIXES=[
    'british-jokes/','classic-move/','haccp-quiz/','hs-learning/','international-logistics/',
    'material-check/','rakuda-no-me/','sutra-no-yoin/',
    'ul-ce-learning/','work-basics/'
  ];
  var LEARN_FILES={
