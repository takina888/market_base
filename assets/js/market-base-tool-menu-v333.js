...
const tools=[
 {id:'calculator',label:'計算機・単位換算',note:'計算と各種換算',icon:'calculator',href:'market-base-currency-converter-v273-r29.html?tool=calculator&v=20260907-v333-19-jfm-v077-currency-hf2'},
 {id:'currency',label:'為替換算',note:'通貨レートを換算',icon:'currency',href:'market-base-currency-converter-v273-r29.html?tool=currency&v=20260907-v333-19-jfm-v077-currency-hf2'},
 {id:'workphoto',label:'WORK PHOTO',note:'写真撮影・加工',icon:'camera',disabled:true,badge:'作成中'},
 {id:'code',label:'WORK CODE',note:'QR・バーコードの読取・作成・共有',icon:'code',href:'market-base-code-tool.html?v=20260907-v333-19-jfm-v077-currency-hf2'}
];
