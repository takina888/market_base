'use strict';
importScripts('./assets/js/market-base-offline-manifest-v324.js?v=20260803-v333-4-radio-state-pc-shell-fix');
const BUILD_ID='MARKET_BASE_V333_4_RADIO_STATE_PC_SHELL_FIX_20260803';
const VERSION=(new URL(self.location.href)).searchParams.get('v')||'20260803-v333-4-radio-state-pc-shell-fix';
...
const REQUIRED=[
  "./",
  "./index.html?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./offline.html?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./version.txt?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/js/market-base-build.js?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/js/market-base-update-controller-v333.js?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/js/market-base-scroll-controls-r11328.js?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/js/market-base-radio-dock-v331.js?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/js/market-base-tool-menu-v333.js?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/css/market-base-tool-menu-v333.css?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/css/market-base-dual-dock-v331.css?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/js/market-base-offline-manifest-v324.js?v=20260803-v333-4-radio-state-pc-shell-fix",
...
const CORE=[
  ...
  "./assets/css/home-search-mode-v332.css?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/js/home-search-mode-v332.js?v=20260803-v333-4-radio-state-pc-shell-fix",
  ...
  "./manifest.json?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./market-base-currency-converter-v273-r29.html?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./market-base-code-tool.html?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/css/market-base-code-tool-v332.css?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/js/market-base-code-tool-v332.js?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/vendor/market-base-qr-generator-v330.js?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/vendor/market-base-barcode-generator-v330.js?v=20260803-v333-4-radio-state-pc-shell-fix",
  ...
  "./assets/css/currency-standard-shell-r11335.css?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/css/prism-calculator-integrated-r1136.css?v=20260803-v333-4-radio-state-pc-shell-fix",
  "./assets/js/prism-calculator-integrated-r1136.js?v=20260803-v333-4-radio-state-pc-shell-fix",
  ...
  "./assets/css/market-base-scroll-controls-r11328.css?v=20260803-v333-4-radio-state-pc-shell-fix",
  ...
  "./assets/flags/flag-svg-data.js?v=20260803-v333-4-radio-state-pc-shell-fix",
  ...
  ,"./world-radio/index.html?v=20260803-v333-4-radio-state-pc-shell-fix"
  ,"./world-radio/player.html?v=20260803-v333-4-radio-state-pc-shell-fix"
  ,"./world-radio/assets/world-radio.css?v=20260803-v333-4-radio-state-pc-shell-fix"
  ,"./world-radio/assets/world-radio-stations.js?v=20260803-v333-4-radio-state-pc-shell-fix"
  ,"./world-radio/assets/world-radio.js?v=20260803-v333-4-radio-state-pc-shell-fix"
  ,"./world-radio/assets/world-radio-player.css?v=20260803-v333-4-radio-state-pc-shell-fix"
  ,"./world-radio/assets/world-radio-player.js?v=20260803-v333-4-radio-state-pc-shell-fix"
...
async function cacheCoreSafely(){
  ...
  const installRequired=[
    ...REQUIRED.slice(0,9),
    "./flight-kitchen-v273-db-title-r27.html?v=20260803-v333-4-radio-state-pc-shell-fix",
    "./embedded-cross-db-search-index-v273-db-title-r27.js?v=20260803-v333-4-radio-state-pc-shell-fix",
    "./world-radio/index.html?v=20260803-v333-4-radio-state-pc-shell-fix",
    "./world-radio/player.html?v=20260803-v333-4-radio-state-pc-shell-fix",
    "./world-radio/assets/world-radio-stations.js?v=20260803-v333-4-radio-state-pc-shell-fix",
    "./world-radio/assets/world-radio.js?v=20260803-v333-4-radio-state-pc-shell-fix",
