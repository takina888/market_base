'use strict';
importScripts('./assets/js/market-base-offline-manifest-v324.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix');
const BUILD_ID='MARKET_BASE_V333_3_RADIO_RESTORE_V331_CURRENCY_RUNTIME_FIX_20260803';
const VERSION=(new URL(self.location.href)).searchParams.get('v')||'20260803-v333-3-radio-restore-v331-currency-runtime-fix';
...
// V333.3: keep the V333 update/tool shell while restoring the stable V331 radio dock.
const REQUIRED=[
  "./",
  "./index.html?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./offline.html?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./version.txt?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./assets/js/market-base-build.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./assets/js/market-base-update-controller-v333.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./assets/js/market-base-scroll-controls-r11328.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  ...
  "./assets/css/market-base-tool-menu-v333.css?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./assets/css/market-base-dual-dock-v331.css?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./assets/js/market-base-offline-manifest-v324.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
...
const CORE=[
  ...
  "./assets/css/home-search-mode-v332.css?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./assets/js/home-search-mode-v332.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  ...
  "./manifest.json?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./market-base-currency-converter-v273-r29.html?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./market-base-code-tool.html?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./assets/css/market-base-code-tool-v332.css?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./assets/js/market-base-code-tool-v332.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./assets/vendor/market-base-qr-generator-v330.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./assets/vendor/market-base-barcode-generator-v330.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  ...
  "./assets/css/currency-standard-shell-r11335.css?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./assets/css/prism-calculator-integrated-r1136.css?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  "./assets/js/prism-calculator-integrated-r1136.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  ...
  "./assets/css/market-base-scroll-controls-r11328.css?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  ...
  "./assets/flags/flag-svg-data.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
  ...
  ,"./world-radio/index.html?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix"
  ,"./world-radio/player.html?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix"
  ,"./world-radio/assets/world-radio.css?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix"
  ,"./world-radio/assets/world-radio-stations.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix"
  ,"./world-radio/assets/world-radio.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix"
  ,"./world-radio/assets/world-radio-player.css?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix"
  ,"./world-radio/assets/world-radio-player.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix"
...
async function cacheCoreSafely(){
  ...
  const installRequired=[
    ...REQUIRED.slice(0,9),
    "./flight-kitchen-v273-db-title-r27.html?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
    "./embedded-cross-db-search-index-v273-db-title-r27.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
    "./world-radio/index.html?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
    "./world-radio/player.html?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
    "./world-radio/assets/world-radio-stations.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
    "./world-radio/assets/world-radio.js?v=20260803-v333-3-radio-restore-v331-currency-runtime-fix",
