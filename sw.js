'use strict';
const BUILD_ID='MARKET_BASE_V317_MAIN_APP_MOBILE_WIDTH_RESTORE_20260729';
const VERSION=(new URL(self.location.href)).searchParams.get('v')||'20260729-v317';
const CACHE_NAME=`market-base-${VERSION}`;
const CORE=[
  "./assets/css/v311-ui-fixes.css?v=20260729-v317",
  "./assets/js/app-v273-country-profile-r28-refresh-route-header-r95.js?v=20260729-v317",
  "./assets/js/market-base-build.js?v=20260729-v317",
  ...
  "./assets/css/map-search-v301.css?v=20260729-v317",
  ...
  "./",
  "./index.html?v=20260729-v317",
  "./version.txt?v=20260729-v317",
  ...
  "./assets/css/world-history-learn-r11330.css?v=20260729-v317",
  ...
  "./assets/js/market-base-build.js?v=20260728-v303-final",
  ...
  "./assets/js/market-base-scroll-controls-r11328.js?v=20260728-v302-back",
