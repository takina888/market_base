'use strict';
importScripts('./assets/js/market-base-offline-manifest-v324.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe');
const BUILD_ID='MARKET_BASE_V333_1_BOTTOM_TOOL_MENU_RADIO_CURRENCY_SAFE_20260803';
const VERSION=(new URL(self.location.href)).searchParams.get('v')||'20260803-v333-1-bottom-tool-menu-radio-currency-safe';
...
const REQUIRED=[
  "./",
  "./index.html?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  "./offline.html?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  "./version.txt?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  "./assets/js/market-base-build.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  "./assets/js/market-base-update-controller-v333.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  "./assets/js/market-base-scroll-controls-r11328.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  ...
  "./assets/css/market-base-tool-menu-v333.css?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  "./assets/css/market-base-radio-dock-v333.css?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  "./assets/js/market-base-offline-manifest-v324.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
...
const CORE=[
  ...
  "./assets/css/home-search-mode-v332.css?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  "./assets/js/home-search-mode-v332.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  ...
  "./manifest.json?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  "./market-base-currency-converter-v273-r29.html?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  "./market-base-code-tool.html?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  "./assets/css/market-base-code-tool-v332.css?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  "./assets/js/market-base-code-tool-v332.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  "./assets/vendor/market-base-qr-generator-v330.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  "./assets/vendor/market-base-barcode-generator-v330.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  ...
  "./assets/css/market-base-scroll-controls-r11328.css?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
  ...
  ,"./world-radio/index.html?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe"
  ,"./world-radio/player.html?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe"
  ,"./world-radio/assets/world-radio.css?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe"
  ,"./world-radio/assets/world-radio-stations.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe"
  ,"./world-radio/assets/world-radio.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe"
  ,"./world-radio/assets/world-radio-player.css?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe"
  ,"./world-radio/assets/world-radio-player.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe"
...
async function cacheCoreSafely(){
  ...
  const installRequired=[
    ...REQUIRED.slice(0,9),
    "./flight-kitchen-v273-db-title-r27.html?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
    "./embedded-cross-db-search-index-v273-db-title-r27.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
    "./world-radio/index.html?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
    "./world-radio/player.html?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
    "./world-radio/assets/world-radio-stations.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
    "./world-radio/assets/world-radio.js?v=20260803-v333-1-bottom-tool-menu-radio-currency-safe",
