(function(){
  ...
  function renderStory(shouldFocus){
    ...
    el.position.textContent=story.number+' / '+stories.length;
  ...
  function renderList(filter){
    ...
    stories.forEach(function(story,index){
      ...
      shown++;
      html+='<button type="button" class="sutra-list-button'+(index===currentIndex?' active':'')+'" data-index="'+index+'"><span class="sutra-list-number">'+String(story.number).padStart(2,'0')+'</span><span class="sutra-list-title">'+escapeHtml(story.title)+'</span></button>';
    });
